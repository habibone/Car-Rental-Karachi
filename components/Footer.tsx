    ...
    <footer className="bg-primary text-white">
      ...
      <div className="py-16 px-4 text-center border-b border-blue-800 bg-blue-900/50">
         ...
         <div className="flex justify-center gap-4">
             <button onClick={scrollToForm} className="bg-cta hover:bg-green-600 text-white px-8 py-3 rounded-full font-bold font-english shadow-lg">Get Started</button>
             <button className="bg-white text-primary px-8 py-3 rounded-full font-bold font-english shadow-lg hover:bg-gray-100">Talk on WhatsApp</button>
         </div>
      </div>
